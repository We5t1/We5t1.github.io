...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      Hello👋,<br /> My name is WE5T
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 text-white">
      I am a bright and passionate Full Stack Software Engineer based in Poland, <br /> driven to craft complex, accessible and responsive web-sites.
      </p>
    </div>
  )
}
